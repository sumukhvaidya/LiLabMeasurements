...
class AWGSetup:
    ...
    def Rabi_2_channel_setup(self):
        ...
        self.sg386.write('FREQ '+str(self.config['freq'] + self.config['nu_IQ']) ) # Set carrier frequency
...
class AWGMeasurement:
    ...
    def run_rabi_sweep(self,  plot_sequence_first=True):
        ...
        for j in tqdm(range(self.config['num_avgs'])):
            # TODO: Implement contrast measurement logic
        ...
        return tau_range, avg_contrast, all_contrast, avg_counts, all_counts, all_data2
